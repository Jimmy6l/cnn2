...
parser.add_argument('--model', default='DsCNN_4', type=str, help='choose a type of model')
...
parser.add_argument('--epoch', default=70, type=int, help='number of train epoches')
...
if __name__ == '__main__':
    ...
    for epoch in range(initial_epoch, n_epoch):
        ...
        for n_count, batch_yx in enumerate(DLoader):  # enumerate() 函数用于将一个可遍历的数据对象
            ...
            print("[epoch %d][%d/%d] loss: %.4f PSNR_train: " %
