...
def parse_args():
    ...
    parser.add_argument('--set_names', default=['moni'], help='directory of test dataset')
    parser.add_argument('--clean_names', default=['moni'], help='directory of test dataset')
    # 噪声水平  默认25
    parser.add_argument('--sigma', default=25, type=int, help='noise level')
    # 模型位置  models/DnCNN_sigma25
    parser.add_argument('--model_dir', default=os.path.join('models', 'DACNN_2_sigma28'), help='directory of the model')
    # 模型名字 默认model_001.pth
    parser.add_argument('--model_name', default='202212model_009.pth', type=str, help='the model name')
    # 结果位置  results
    parser.add_argument('--result_dir', default='results/DACNN_0413', type=str, help='directory of test dataset')
    # 保存结果 1保存 0不保存
        ...
        for im in os.listdir(os.path.join(args.set_dir, set_cur)):
            if im.endswith(".jpg") or im.endswith(".bmp") or im.endswith(".png"):
                ...
                if args.save_result:
                    ...
                    save_result(x_, path=os.path.join(args.result_dir, set_cur, name+'_dacnn3'+ext))  # save the denoised image
