...
def parse_args():
    ...
    # 增加参数
    # 测试集  data/Test
    parser.add_argument('--set_dir', default='data/Test1', type=str, help='directory of test dataset')
    parser.add_argument('--clean_dir', default='data/Clean', type=str, help='directory of clean test dataset')
    # 测试集名字  set68 set12 , 'Set12'
    parser.add_argument('--set_names', default=['5_3'], help='directory of test dataset')
    parser.add_argument('--clean_names', default=['5_3'], help='directory of test dataset')
    # 噪声水平  默认25
    parser.add_argument('--sigma', default=25, type=int, help='noise level')
    # 模型位置  models/DnCNN_sigma25
    parser.add_argument('--model_dir', default=os.path.join('models', 'DsCNN_binld_sigma28'), help='directory of the model')
    # 模型名字 默认model_001.pth
    parser.add_argument('--model_name', default='202212model_029.pth', type=str, help='the model name')
    # 结果位置  results
    parser.add_argument('--result_dir', default='results/DsCNN_binld5_3_5_3', type=str, help='directory of test dataset')
    # 保存结果 1保存 0不保存
